...
/**
 * Represents main menu screen in the game, handles drawing main menu ui.
 */
public class MainMenu extends GameScreen {
     ...
     */
    public MainMenu(SpriteBatch batch, Main game, Localisation local) {
