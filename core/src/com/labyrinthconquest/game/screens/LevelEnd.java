...
import com.labyrinthconquest.game.ui.LevelEndUi;
import com.labyrinthconquest.game.ui.Localisation;

/**
 * Represents level end screen in the game, handles drawing level end ui.
 */
public class LevelEnd extends GameScreen {
    /**
     * Ui data for this screen
     */
    private LevelEndUi ui;
    public int lvl;
    public int score;

    /**
     * Constructor for level end screen
     * @param batch spritebatch
     * @param game Main game object
     * @param local localisation object
     */
    public LevelEnd(SpriteBatch batch, Main game, Localisation local) {
     ...
     */
    public void show() {
        ui = new LevelEndUi(game, local, lvl, score);
    }
